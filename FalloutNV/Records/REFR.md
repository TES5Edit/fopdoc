...
+ | TNAM | Map Marker Data | struct |
 | WMI1 | Map Marker Reputation | formid | FormID of a [REPU](REPU.html) record.
 | MMRK | Audio Marker | null |
 | FULL | ?? | ?? |
 | CNAM | Audio Location | formid | FormID of an [ALOC](ALOC.html) record.
 | BNAM | ?? | ?? |
 | MNAM | ?? | float32 |
 | NNAM | ?? | float32 |
 | XSRF | ?? | ?? |
